...
export default class Forecast extends Component {
  ...
  addPersonModal(){
    $('#addPersonModal').modal('attach events', '.forecastModal .button').modal('show')
  }
              ...
              <div className="exactSearchList" style={{height:60,display:'none'}}>
                <div className="ui form">
                  <div className="inline fields">
                    ...
                    <div className="field">
                      <label style={{height:38,lineHeight:'38px'}}>人员</label>
                      <Dropdown className="item ui multiple selection dropdown mini right" init={true} style={{height:'auto'}}>
                        <input name="states" type="hidden"/>
                          <i className="dropdown icon"></i>
                          <div className="default text">人员</div>
                          <div className="menu">
                            <a className="item" data-value="1">陈柳颖</a>
                            <a className="item" data-value="2">黄艳婷</a>
                            <a className="item" data-value="3">高婷婷</a>
